...
<h3 align="center">A Minimal Docker-like Container Runtime in User Space</h3>
...
| **Project Title** | uDock – Minimal Docker-like Container Runtime |
...
║  image with a link works perfectly and looks professional!                    ║
║                                                                               ║
╚═══════════════════════════════════════════════════════════════════════════════╝
-->
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=YOUR_VIDEO_ID">
    <img src="https://img.youtube.com/vi/YOUR_VIDEO_ID/maxresdefault.jpg" alt="uDock Demo Video" width="600">
  </a>
</p>

<p align="center">
  <strong>▶️ Click the image above to watch the full demonstration</strong>
</p>
...
**uDock** is a minimal container runtime implemented entirely in C, designed to demonstrate core operating system concepts through practical implementation. Unlike production container runtimes, uDock focuses on educational clarity while maintaining functional correctness.

### What is a Container?

A container is an isolated execution environment that provides:
- **Filesystem Isolation**: Separate root filesystem view via `chroot()`
- **Process Isolation**: Independent process with controlled environment
- **Resource Control**: CPU and memory limits via `setrlimit()`
...
| **Practical** | Build a working container runtime from scratch |
| **Complete** | Cover process management, filesystem, signals, and resource control |
| **Documented** | Maintain comprehensive development logs using STAR method |
